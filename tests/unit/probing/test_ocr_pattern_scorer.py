...
def test_score_ordinal_patterns_empty():
    res = score_ordinal_patterns([])
    assert res.ordinal_pattern_score == 0.0
    assert res.countdown_likelihood == 0.0

def test_score_ordinal_patterns_high_density_no_countdown():
    ...
    res = score_ordinal_patterns(segments)
...
def test_score_ordinal_patterns_countdown():
    segments = [
...
def test_score_ordinal_patterns_no_numbers():
    segments = [
